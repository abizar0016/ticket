        ...
        <div
            ...
            <div class="flex justify-between items-start">
                <div>
                    ...
                    <h3 class="md:text-3xl text-xl font-bold mt-2 animate-count">{{ $orderItemsCount }}</h3>
                </div>
        ...
        <div
            ...
            <div class="flex justify-between items-start">
                <div>
                    ...
                    <h3 class="md:text-3xl text-xl font-bold mt-2 animate-count">{{ $attendeeCount }}</h3>
                </div>
                <div class="p-3 bg-white/20 rounded-xl backdrop-blur-sm group-hover:rotate-12 transition-transform">
                    ...
                    <h3 class="md:text-3xl text-xl font-bold mt-2">
                        <span class="animate-count">Rp. 
                            {{ $revenueTotal >= 1000000
                                ? number_format($revenueTotal / 1000000, 1, ',', '.') . ' jt'
        ...
        <div
            ...
            <div class="flex justify-between items-start">
                <div>
                    ...
                    <h3 class="md:text-3xl text-xl font-bold mt-2 animate-count">{{ $completedOrders }}</h3>
                </div>
                <div class="p-3 bg-white/20 rounded-xl backdrop-blur-sm group-hover:rotate-12 transition-transform">
