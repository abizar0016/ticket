    ...
    <div class="min-h-screen p-6">
        ...
        <div
            ...
            <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                ...
                <!-- Search Bar -->
                <form method="GET" action="{{ route('home.admin') }}"s
                    class="hidden lg:block relative w-72 transition-all hover:-translate-y-0.5">
                    ...
                    <input type="search" name="search"
                        ...
                        placeholder="Search events by name..." value="{{ request('search') }}">
                </form>
