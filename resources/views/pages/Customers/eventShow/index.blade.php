...
@section('content')
    <section class="event-show-page overflow-hidden">
        ...
        <div class="event-hero w-full h-screen bg-cover bg-center relative overflow-hidden group"
            ...
            <div class="absolute bottom-16 left-1/2 transform -translate-x-1/2 z-10">
                <a href="#event-content" class="flex flex-col items-center group animate-bounce">
                    <span class="text-gray-300 text-sm mb-2 group-hover:text-primary-600 transition-colors duration-300">
                        EXPLORE
                    </span>
                    <i
        ...
        <div id="event-content" class="relative bg-white text-gray-900 py-24 overflow-hidden">
        ...
        <div class="relative bg-white text-gray-900 py-24 overflow-hidden">
            <div class="absolute inset-0 bg-gradient-to-br from-white via-gray-100 to-gray-200 opacity-70 z-0"></div>
                            ...
                            <div class="space-y-3 md:space-y-4">
                                            ...
                                            <div class="flex flex-col sm:flex-row sm:justify-between sm:items-start">
                                                <div>
                                                    ...
                                                    <p class="text-xs md:text-sm text-gray-500 mt-1">
                                                        Scan mode: <span
                                                            class="font-medium text-gray-700">{{ ucfirst($ticket->scan_mode ?? 'single') }}</span>
                                                    </p>
                                                ...
                                                <div class="text-left sm:text-right mt-3 sm:mt-0">
                                                    <p class="text-lg md:text-xl font-bold text-primary-600">
                                                    ...
                                                    <p class="text-xs text-gray-500 mt-1">
                                                        ...
                                                        @elseif ($ticket->quantity <= 0)
                                                            <span class="font-semibold text-red-600">Sold Out</span>
                                                        @else
                                                            <span
                                                                class="font-medium text-gray-700">{{ $ticket->quantity . ' available' }}</span>
                                                        @endif
                                                    </p>
                                                </div>
                                            </div>
                                ...
                                @empty
                                    <div class="text-center py-6 md:py-10">
                                        ...
                                        <p class="text-gray-500 text-sm md:text-base">No tickets available at this time</p>
                                    </div>
                                @endforelse
                        ...
                        <div class="merchandise-column mt-6 md:mt-0">
                            ...
                            <div class="space-y-3 md:space-y-4">
                                @forelse ($event->products->where('type', '!=', 'ticket') as $product)
                                    ...
                                    <div
                                        class="product-card group relative bg-white rounded-lg md:rounded-xl shadow-sm hover:shadow-md border border-gray-200 hover:border-primary-300 transition-all duration-300 overflow-hidden mb-4">
                                        <div
                                                ...
                                                <div class="flex flex-col sm:flex-row sm:justify-between sm:items-start">
                                                    ...
                                                    <div class="text-left sm:text-right">
                                                        ...
                                                        <p class="text-xs text-gray-500 mt-1">
                                                            ...
                                                            @else
                                                                <span
                                                                    class="font-medium text-gray-700">{{ $product->quantity . ' available' }}</span>
                                                            @endif
                                                        </p>
                                                    </div>
                                                </div>
                                ...
                                @empty
                                    <div class="text-center py-6 md:py-10">
                                        ...
                                        <p class="text-gray-500 text-sm md:text-base">No merchandise available at this time
                                        </p>
                                    </div>
                                @endforelse
                            </div>
                    ...
                    <div class="bg-white rounded-2xl overflow-hidden shadow-xl">
                        @if ($event->custom_maps_url)
                            ...
                            <div class="p-6 bg-white border-t border-gray-100">
                                <div class="flex flex-col md:flex-row md:items-center md:justify-between">
                                    <div>
                                        <h3 class="text-xl font-bold text-gray-900">{{ $event->venue_name }}
                                        </h3>
                                    ...
                                    <a href="{{ $event->custom_maps_url }}" target="_blankk"
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function updateOrderSummary() {
                ...
                if (totalItems > 0) summary.classList.add('show');
