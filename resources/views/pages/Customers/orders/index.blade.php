...
@section('content')
    <div class="max-w-4xl mx-auto px-4 sm:px-6 py-8">
        <h1 class="text-2xl font-bold text-gray-900 mb-6">Daftar Pesanan Saya</h1>
                            ...
                            <li class="px-6 py-4 hover:bg-gray-50">
                                <div class="flex items-center justify-between">
                                    <div class="flex items-center space-x-4">
                                        ...
                                        <div>
                                            <p class="text-sm font-medium text-gray-900">Order {{ $loop->iteration }}
                                            </p>
        ...
        @else
            <div class="bg-white rounded-lg shadow overflow-hidden text-center py-12">
                ...
                <div class="mt-6">
                    <a href="{{ route('home') }}"
                        class="inline-flex items-center px-4 py-2 bg-indigo-600 border border-transparent rounded-lg text-sm font-medium text-white hover:bg-indigo-700">
