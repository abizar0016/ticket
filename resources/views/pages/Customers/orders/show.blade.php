...
<div class="max-w-4xl mx-auto px-4 sm:px-6 py-8">
    <div class="bg-gray-900 dark:bg-gray-900 rounded-xl shadow-sm border border-gray-700 overflow-hidden">
        ...
        <div class="p-6">
                                            ...
                                            <div class="bg-gray-700 rounded-lg p-3 border border-gray-600">
                                                <div
                                                    ...
                                                    <div>
                                                        ...
                                                        <p class="text-sm text-gray-300">{{ $attendee->phone ?? '-' }}</p>
            ...
            <!-- Customer Info -->
            <div class="mb-8">
                <h2 class="text-lg font-semibold text-gray-200 border-b border-gray-700 pb-2 mb-4">Informasi Pembeli</h2>
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4 text-gray-300">
                    ...
                    <div>
                        ...
                        <p class="font-medium text-gray-100">{{ $order->phone ?? '-' }}</p>
                    </div>
                </div>
            </div>
