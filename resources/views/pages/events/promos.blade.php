    ...
    <div class="grid grid-cols-1 lg:grid-cols-12 gap-6">
        ...
        <div
            ...
            <div class="relative z-10 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 sm:gap-6">
                <div class="flex items-center gap-4 sm:gap-6">
                    ...
                    <div>
                        <h1 class="text-2xl sm:text-3xl font-bold text-gray-800 dark:text-gray-100 tracking-tight">Promo Codes</h1>
                        <p class="text-indigo-600/80 dark:text-indigo-400 text-base sm:text-lg mt-1 sm:mt-2">Manage discounts and special offers</p>
                    </div>
                </div>
            ...
            <div class="absolute -right-6 -top-6 sm:-right-10 sm:-top-10 text-black/10 dark:text-white/10 text-7xl sm:text-9xl z-0">
        ...
        <div class="lg:col-span-12 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 mb-6">
            ...
            <div
                ...
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <h3 class="text-xl sm:text-2xl font-bold text-gray-900 dark:text-gray-100 mt-1">{{ $totalPromos }}</h3>
                    </div>
                    <div class="p-2 sm:p-3 rounded-md sm:rounded-lg bg-purple-100 dark:bg-purple-900/40 text-purple-600 dark:text-purple-400">
            ...
            <div
                ...
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <h3 class="text-xl sm:text-2xl font-bold text-gray-900 dark:text-gray-100 mt-1">{{ $activePromos }}</h3>
                    </div>
                    <div class="p-2 sm:p-3 rounded-md sm:rounded-lg bg-green-100 dark:bg-green-900/40 text-green-600 dark:text-green-400">
            ...
            <div
                ...
                <div class="flex items-center justify-between">
                    <div>
                        <p class="text-xs sm:text-sm font-medium text-gray-500 dark:text-gray-400">Total Discounts Given</p>
                        <h3 class="text-xl sm:text-2xl font-bold text-gray-900 dark:text-gray-100 mt-1">
                            Rp {{ number_format($totalDiscounts, 0, ',', '.') }}
                        </h3>
                    </div>
                    <div class="p-2 sm:p-3 rounded-md sm:rounded-lg bg-blue-100 dark:bg-blue-900/40 text-blue-600 dark:text-blue-400">
            ...
            <div class="overflow-x-auto">
                <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                    <thead class="bg-gray-50 dark:bg-gray-900">
                        <tr>
                            <th class="px-4 py-2 sm:px-6 sm:py-3 text-left text-xs sm:text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider">Name</th>
                            <th class="px-4 py-2 sm:px-6 sm:py-3 text-left text-xs sm:text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider">Code</th>
                            <th class="px-4 py-2 sm:px-6 sm:py-3 text-left text-xs sm:text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider">Discount</th>
                            <th class="px-4 py-2 sm:px-6 sm:py-3 text-left text-xs sm:text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider hidden sm:table-cell">Applicable To</th>
                            <th class="px-4 py-2 sm:px-6 sm:py-3 text-left text-xs sm:text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider hidden sm:table-cell">Used</th>
                            <th class="px-4 py-2 sm:px-6 sm:py-3 text-right text-xs sm:text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider">Actions</th>
                        </tr>
                    </thead>
                            ...
                            <tr class="hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors duration-150">
                                <td class="px-4 py-3 sm:px-6 sm:py-4 whitespace-nowrap">
                                    <div class="flex items-center">
                                        <div class="flex-shrink-0 h-8 w-8 sm:h-10 sm:w-10 bg-purple-100 dark:bg-purple-900/40 rounded-md sm:rounded-lg flex items-center justify-center text-purple-600 dark:text-purple-400">
                                        ...
                                        <div class="ml-3 sm:ml-4">
                                            ...
                                            <div class="text-xs text-gray-500 dark:text-gray-400">Created: {{ $promo->created_at->format('M d, Y') }}</div>
                                        </div>
                                    </div>
                                </td>
                                <td class="px-4 py-3 sm:px-6 sm:py-4 whitespace-nowrap">
                                    <div class="text-sm font-semibold text-gray-900 dark:text-gray-100">{{ $promo->code }}</div>
                                </td>
                                <td class="px-4 py-3 sm:px-6 sm:py-4 whitespace-nowrap">
                                ...
                                <td class="px-4 py-3 sm:px-6 sm:py-4 whitespace-nowrap hidden sm:table-cell">
                                    <div class="flex flex-col gap-1">
                                        @if ($promo->is_ticket && $promo->is_merchandise)
                                            <span class="inline-flex items-center px-2 py-0.5 rounded text-xs font-medium bg-blue-100 dark:bg-blue-900/40 text-blue-800 dark:text-blue-400">Ticket</span>
                                            <span class="inline-flex items-center px-2 py-0.5 rounded text-xs font-medium bg-green-100 dark:bg-green-900/40 text-green-800 dark:text-green-400">Merchandise</span>
                                ...
                                <td class="px-4 py-3 sm:px-6 sm:py-4 whitespace-nowrap hidden sm:table-cell">
                                    <div class="flex items-center gap-2">
                                        <div class="w-12 sm:w-16 bg-gray-200 dark:bg-gray-700 rounded-full h-1.5 sm:h-2">
                                ...
                                <td class="px-4 py-3 sm:px-6 sm:py-4 whitespace-nowrap text-right">
                                    <div class="flex justify-end items-center gap-1 sm:gap-2">
                                        <button id="open-promo-update-modal-{{ $promo->id }}" data-id="{{ $promo->id }}"
