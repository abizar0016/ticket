                            ...
                            <tr class="hover:bg-gray-50 transition-colors duration-150">
                                ...
                                <td class="px-4 py-3 sm:px-6 sm:py-4 whitespace-nowrap text-right">
                                    <div class="flex justify-end items-center gap-1 sm:gap-2">
                                        ...
                                        data-id="{{ $promo->id }}"
                                            class="p-1.5 sm:p-2 text-gray-600 hover:text-indigo-600 rounded-md sm:rounded-lg transition-all duration-200 cursor-pointer"
                                            title="Edit">
                                        ...
                                        <form
                                            ...
                                            <button type="submit"
                                                ...
                                                class="p-1.5 sm:p-2 text-gray-600 hover:text-red-600 rounded-md sm:rounded-lg transition-all duration-200 cursor-pointer"
                                                title="Delete">
