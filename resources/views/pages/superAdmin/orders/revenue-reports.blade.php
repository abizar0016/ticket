<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6">
    ...
    <div class="bg-white rounded-xl shadow p-4 sm:p-6">
        <h2 class="text-base sm:text-lg font-semibold text-gray-700">Total Revenue</h2>
        <p class="text-2xl sm:text-3xl font-bold text-indigo-600 mt-2">
    ...
    <!-- Revenue per Event -->
    <div class="bg-white rounded-xl shadow p-4 sm:p-6">
        <h2 class="text-base sm:text-lg font-semibold text-gray-700 mb-4">Revenue by Event</h2>
        <div class="overflow-x-auto">
            <table class="min-w-full divide-y divide-gray-200 text-sm">
                <thead class="bg-gray-50">
                    <tr>
                        <th class="px-4 py-3 text-left font-medium text-gray-500">Event</th>
                        <th class="px-4 py-3 text-left font-medium text-gray-500">Revenue</th>
                    </tr>
                </thead>
    ...
    <div class="bg-white rounded-xl shadow p-4 sm:p-6">
        <h2 class="text-base sm:text-lg font-semibold text-gray-700 mb-4">Revenue by Month</h2>
    ...
    <!-- Order Detail -->
    <div class="bg-white rounded-xl shadow p-4 sm:p-6">
        <h2 class="text-base sm:text-lg font-semibold text-gray-700 mb-4">Paid Orders</h2>
        <div class="overflow-x-auto">
            <table class="min-w-full divide-y divide-gray-200 text-sm">
                <thead class="bg-gray-50">
                    <tr>
                        <th class="px-4 py-3 text-left text-gray-500">#</th>
                        <th class="px-4 py-3 text-left text-gray-500">Event</th>
                        <th class="px-4 py-3 text-left text-gray-500">Customer</th>
