    ...
    <div class="bg-white rounded-xl shadow p-6 overflow-x-auto">
        <table class="min-w-full border border-gray-200 rounded-lg overflow-hidden">
            <thead class="bg-gray-50">
                <tr>
                    <th class="px-6 py-3 text-sm font-medium text-gray-500 text-left">No.</th>
                    <th class="px-6 py-3 text-sm font-medium text-gray-500 text-left">Name</th>
                    <th class="px-6 py-3 text-sm font-medium text-gray-500 text-left">Created By</th>
                    <th class="px-6 py-3 text-sm font-medium text-gray-500 text-left">Created At</th>
                    <th class="px-6 py-3 text-sm font-medium text-gray-500 text-left">Actions</th>
                </tr>
            </thead>
                    ...
                    <tr>
                        ...
                        <td class="px-6 py-4">
                            <div class="flex space-x-2">
                                ...
                                <a href="#"
                                    class="px-2 py-1 text-xs rounded-md bg-yellow-100 text-yellow-700 flex items-center space-x-1">
