                            ...
                            <tr
                                ...
                                <td class="px-6 py-5 text-right">
                                    <div class="flex justify-end gap-2">
                                        <button id="open-organizations-update-modal-{{ $org->id }}"
                                        ...
                                        <form action="{{ route('organizations.delete', $org->id) }}" method="POST"
                                            class="inline ajax-form" data-success="Organization deleted successfully."
            ...
            @forelse ($organizations as $org)
                <div
                    ...
                    <div class="flex justify-end gap-2 mt-3">
                        <button id="open-organizations-update-modal-{{ $org->id }}" data-id="{{ $org->id }}"
...
@include('modals.organizations.update')
