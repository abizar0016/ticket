<div class="min-h-screen bg-gray-50">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-12 gap-6">
        ...
        <div class="lg:col-span-8">
            <form id="update-event-form" action="" method="POST" enctype="multipart/form-data"
                ...
                <div class="bg-white shadow-lg sm:shadow-2xl rounded-xl sm:rounded-2xl p-4 sm:p-6">
                    ...
                    <div class="relative group">
                        <select id="status" name="status"
                            class="w-full px-4 sm:px-5 py-3 sm:py-4 pl-12 sm:pl-14 pr-10 sm:pr-12 text-base sm:text-lg rounded-lg sm:rounded-xl border-2 border-gray-200 focus:border-indigo-500 outline-none focus:ring-0 bg-white text-gray-800 transition-all duration-300 shadow-sm group-hover:border-indigo-300 appearance-none peer">
                            <option value="draft" {{ old('status', $events->status) === 'draft' ? 'selected' : '' }}>
                                Draft</option>
                            <option value="published"
                                {{ old('status', $events->status) === 'published' ? 'selected' : '' }}>Published
                            </option>
                        </select>
                        <label for="status"
                            class="absolute left-12 sm:left-14 top-3 sm:top-4 px-2 text-gray-500 text-sm sm:text-base transition-all duration-300 transform -translate-y-7 sm:-translate-y-9 scale-90 bg-white rounded peer-focus:-translate-y-7 sm:peer-focus:-translate-y-9 peer-focus:scale-90 peer-focus:text-indigo-600">
                            Status
                        </label>
                        <div
                            class="absolute inset-y-0 left-0 pl-4 sm:pl-5 flex items-center pointer-events-none text-indigo-600">
                        ...
                        <div
                            class="absolute inset-y-0 right-0 pr-4 sm:pr-5 flex items-center pointer-events-none text-gray-400">
                    ...
                    <div class="space-y-4 sm:space-y-6">
                        ...
                        <div class="relative group">
                            <input type="text" id="venue_name" name="venue_name"
                                value="{{ old('venue_name', $events->location->venue_name ?? '') }}"
                                class="w-full px-4 sm:px-5 py-3 sm:py-4 pl-12 sm:pl-14 text-base sm:text-lg rounded-lg sm:rounded-xl border-2 border-gray-200 focus:border-indigo-500 outline-none focus:ring-0 bg-white text-gray-800 transition-all duration-300 shadow-sm group-hover:border-indigo-300 peer"
                                placeholder=" ">
                        ...
                        <div class="relative group">
                            <input type="text" id="address_line" name="address_line"
                                value="{{ old('address_line', $events->location->address_line ?? '') }}"
                                class="w-full px-4 sm:px-5 py-3 sm:py-4 pl-12 sm:pl-14 text-base sm:text-lg rounded-lg sm:rounded-xl border-2 border-gray-200 focus:border-indigo-500 outline-none focus:ring-0 bg-white text-gray-800 transition-all duration-300 shadow-sm group-hover:border-indigo-300 peer"
                                placeholder=" ">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
                            ...
                            <div class="relative group">
                                <input type="text" id="city" name="city"
                                    value="{{ old('city', $events->location->city ?? '') }}"
                                    class="w-full px-4 sm:px-5 py-3 sm:py-4 pl-12 sm:pl-14 text-base sm:text-lg rounded-lg sm:rounded-xl border-2 border-gray-200 focus:border-indigo-500 outline-none focus:ring-0 bg-white text-gray-800 transition-all duration-300 shadow-sm group-hover:border-indigo-300 peer"
                                    placeholder=" ">
                                <label for="city"
                                    class="absolute left-12 sm:left-14 top-3 sm:top-4 px-2 text-gray-500 text-sm sm:text-base transition-all duration-300 transform -translate-y-7 sm:-translate-y-9 scale-90 bg-white rounded peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:-translate-y-7 sm:peer-focus:-translate-y-9 peer-focus:scale-90 peer-focus:text-indigo-600">
                            ...
                            <div class="relative group">
                                <input type="text" id="state" name="state"
                                    value="{{ old('state', $events->location->state ?? '') }}"
                                    class="w-full px-4 sm:px-5 py-3 sm:py-4 pl-12 sm:pl-14 text-base sm:text-lg rounded-lg sm:rounded-xl border-2 border-gray-200 focus:border-indigo-500 outline-none focus:ring-0 bg-white text-gray-800 transition-all duration-300 shadow-sm group-hover:border-indigo-300 peer"
                                    placeholder=" ">
                                <label for="state"
                                    class="absolute left-12 sm:left-14 top-3 sm:top-4 px-2 text-gray-500 text-sm sm:text-base transition-all duration-300 transform -translate-y-7 sm:-translate-y-9 scale-90 bg-white rounded peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:-translate-y-7 sm:peer-focus:-translate-y-9 peer-focus:scale-90 peer-focus:text-indigo-600">
                        ...
                        <div class="relative group">
                            <input type="url" id="custom_maps_url" name="custom_maps_url"
                                value="{{ old('custom_maps_url', $events->location->custom_maps_url ?? '') }}"
                                class="w-full px-4 sm:px-5 py-3 sm:py-4 pl-12 sm:pl-14 text-base sm:text-lg rounded-lg sm:rounded-xl border-2 border-gray-200 focus:border-indigo-500 outline-none focus:ring-0 bg-white text-gray-800 transition-all duration-300 shadow-sm group-hover:border-indigo-300 peer"
                                placeholder="">
