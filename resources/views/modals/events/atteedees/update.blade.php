@foreach ($attendees as $attendee)
    <div id="attendeesUpdateModal-{{ $attendee->id }}" class="fixed flex justify-center items-center inset-0 z-50 hidden overflow-y-auto">
        <div class="flex items-center justify-center sm:block sm:p-0">
            ...
            <!-- Modal Panel -->
            <div class=" bg-white rounded-2xl text-left overflow-hidden shadow-xl transform transition-all sm:max-w-2xl w-full opacity-0 translate-y-4 scale-95"
                ...
                <div class="bg-white px-6 pt-6 pb-4 sm:p-6">
                    ...
                    <form id="update-attendee-form-{{ $attendee->id }}"
                        ...
                        class="ajax-form"
                        data-success="Attendee updated successfully."
