        ...
        <div
            ...
            <div class="flex justify-between items-start">
                <div>
                    ...
                    <h3 class="text-3xl font-bold mt-2 animate-count">{{ $orderItemsCount }}</h3>
                </div>
        ...
        <div
            ...
            <div class="flex justify-between items-start">
                <div>
                    ...
                    <h3 class="text-3xl font-bold mt-2 animate-count">{{ $attendeeCount }}</h3>
                </div>
                <div class="p-3 bg-white/20 rounded-xl backdrop-blur-sm group-hover:rotate-12 transition-transform">
        ...
        <div
            ...
            <div class="flex justify-between items-start">
                <div>
                    ...
                    <h3 class="text-3xl font-bold mt-2 animate-count">{{ $completedOrders }}</h3>
                </div>
                <div class="p-3 bg-white/20 rounded-xl backdrop-blur-sm group-hover:rotate-12 transition-transform">
