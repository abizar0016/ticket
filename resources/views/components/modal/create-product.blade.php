            ...
            <div class="bg-white rounded-4xl max-h-[90vh] overflow-y-auto px-6 pt-6 pb-4 sm:p-6 sm:pb-4">
                <div class="flex items-start justify-between">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-gray-500 mt-1 text-start">Configure your item details</p>
                    </div>
                        ...
                        <div class="grid grid-cols-1  gap-6">
                            ...
                            <div class="relative group">
                                <div id="itemUploadContainer"
                                    class="border-2 border-dashed border-gray-300 rounded-xl p-4 transition-all duration-300 hover:border-indigo-400 bg-white cursor-pointer">
