            ...
            <div class="bg-white px-6 pt-6 pb-4 sm:p-6 max-h-[90vh] overflow-y-auto">
                ...
                <div class="flex items-start justify-between mb-6">
                    <div class="flex items-start gap-4">
                        <div id="itemTypeIcon" class="p-3 rounded-xl bg-gradient-to-tr from-indigo-500 to-indigo-600 text-white shadow-lg">
                            <i class="ri-ticket-2-line text-2xl"></i>
                        </div>
                        <div>
                            <h3 class="text-2xl font-bold text-gray-900" id="modalTitle">Add New Item</h3>
                            <p class="text-indigo-600/80 text-lg mt-1" id="modalSubtitle">Configure your item details</p>
                        </div>
                    </div>
                ...
                {{-- Form --}}
                <form id="create-item-form" action="{{ route('product.store', ['id' => $event->id]) }}" method="POST" enctype="multipart/form-data">
                    @csrf
